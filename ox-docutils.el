...
CITATION is a `latex-fragment' object satisfying
to `org-docutils-bibtex-citation-p' predicate."
...
(defun org-docutils-latex-fragment (latex-fragment _contents info)
  ...
  (if (org-docutils-bibtex-citation-p latex-fragment)
      (let ((lbl (org-docutils-bibtex-get-citation-key latex-fragment))
